        ...
        <div>
            ...
            <div className="mt-8">
                ...
                <div className="flex justify-between">
                    <div className="text-start bg-purple-100 items-center justify-center rounded-lg p-3"><h2 className="text-xl font-semibold text-purple-700">Total  Surveys</h2></div>
