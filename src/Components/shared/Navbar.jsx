        ...
        <>
            <div className="navbar fixed z-10 w-[1200px] bg-opacity-10 bg-black">
                <div className="navbar-start">
                    ...
                    <Link to='/'><a className="btn btn-ghost text-xl text-purple-500">Survey Sphere</a></Link>
                </div>
                            ...
                            <>
                                <div className="dropdown dropdown-end">
                                    ...
                                    <ul tabIndex={0} className="menu menu-lg dropdown-content mt-2 z-[1] p-1 shadow rounded-box w-52">
                                        <li>
                                            <h3 className="text-purple-800 text-base font-medium">{user.displayName
                                            }</h3>
                                        </li>
                                        <li><button onClick={handleSignOut} className="btn text-purple-800">Sign out</button></li>
